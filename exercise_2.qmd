...
- It is possible to select "AGE" in the "Summarize Variables" input which does not make much sense. Let's limit the selection to only a few interesting columns of your choice. Which object to change?
